...
$query_brac_deptQuery = "SELECT * FROM brac_dept";
$brac_deptQuery = mysql_query($query_brac_deptQuery, $MySql) or die(mysql_error());
$row_brac_deptQuery = mysql_fetch_assoc($brac_deptQuery);
$totalRows_brac_deptQuery = mysql_num_rows($brac_deptQuery);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
  	<!-- Title -->
    <title>show  University Department</title>
...
<table width="70%" class="table table-striped table-hover ">
  <thead class="sortable">
    <tr>
      
      <th width="50%">Depertment Id</th>
  ...
  <tbody>
    <?php do { ?>
      <tr>
        <td><?php echo $row_brac_deptQuery['bdept_id']; ?></td>
        <td><?php echo $row_brac_deptQuery['Depertment_name']; ?></td>
        <td>&nbsp;</td>
        
      </tr>
      <?php } while ($row_brac_deptQuery = mysql_fetch_assoc($brac_deptQuery)); ?>
  </tbody>
</table> 
	<p>
...
<?php
mysql_free_result($brac_deptQuery);
?>
