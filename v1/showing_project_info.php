...
$query_project_query = "SELECT * FROM `project description`";
$project_query = mysql_query($query_project_query, $MySql) or die(mysql_error());
$row_project_query = mysql_fetch_assoc($project_query);
$totalRows_project_query = mysql_num_rows($project_query);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
  	<!-- Title -->
    <title>View Project Information</title>
  ...
  <div class="row">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 style="color:#00F" >
           Project List & Working Members of Robotics Club
          </h4>
        </div>
  ...
  <tbody>
    ...
    <?php do { ?>
      <tr>
        ...
        <td><?php echo $row_project_query['proj_id']; ?></td>
        <td><?php echo $row_project_query['P_Name']; ?></td>
        <td><?php echo $row_project_query['Proj_desc']; ?></td>
        <td><?php echo $row_project_query['Proj_Destination']; ?></td>
        <td><?php echo $row_project_query['Current_status']; ?></td>
        <td>&nbsp;</td>
      </tr>
      <?php } while ($row_project_query = mysql_fetch_assoc($project_query)); ?>
  </tbody>
</table> 
</div>
  </div>
...
<?php
mysql_free_result($project_query);
?>
